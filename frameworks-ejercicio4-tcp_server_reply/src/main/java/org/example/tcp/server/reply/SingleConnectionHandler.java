...
public class SingleConnectionHandler implements IConnectionHandler {
    ...
    private SessionTerminationStrategy endSessionPolicy;

    public SingleConnectionHandler(IMessageHandler messageHandler, SessionTerminationStrategy endSessionPolicy,
        ...
        try (
                ...
                BufferedReader in = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()));) {
                    ...
                    while ((inputLine = in.readLine()) != null) {
                        ...
                        if (endSessionPolicy.shouldTerminate(inputLine)) {
